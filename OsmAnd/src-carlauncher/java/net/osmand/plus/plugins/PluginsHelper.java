...
public class PluginsHelper {
    ...
    public static void initPlugins(@NonNull OsmandApplication app) {
        ...
        allPlugins.add(new ParkingPositionPlugin(app));
    ...
    private static boolean updateMarketPlugin(@NonNull OsmandApplication app,
        ...
        // for test reasons
        // if ((Version.isDeveloperVersion(app) || !Version.isProductionVersion(app)) &&
        // !paid) {
        // marketEnabled = false;
        // }
    ...
    public static void registerConfigureMapCategory(@NonNull ContextMenuAdapter adapter,
    ...
    public static void onOptionsMenuActivity(FragmentActivity activity, Fragment fragment, Set<TrackItem> selectedItems,
    ...
    public static boolean onSearchFinished(QuickSearchDialogFragment searchFragment, SearchPhrase phrase,
    ...
    public static String onGetMapObjectPreferredLang(MapObject object, String preferredMapLang,
            String preferredMapAppLang) {
        for (OsmandPlugin plugin : getEnabledPlugins()) {
    ...
    public static OrderedLineDataSet getOrderedLineDataSet(@NonNull LineChart chart,
        ...
        for (OsmandPlugin plugin : getAvailablePlugins()) {
            OrderedLineDataSet dataSet = plugin.getOrderedLineDataSet(chart, analysis, graphType, axisType,
    ...
    public static void getAvailableGPXDataSetTypes(@NonNull GpxTrackAnalysis analysis,
