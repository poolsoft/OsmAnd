...
import net.osmand.plus.carlauncher.headunit.HardwareMediaKeyRouter;
...
public class CarMediaService extends MediaBrowserService implements MusicManager.MusicUIListener {
    ...
    public static final String ACTION_PLAY_PAUSE =
            "net.osmand.plus.carlauncher.media.action.PLAY_PAUSE";
    public static final String ACTION_NEXT =
            "net.osmand.plus.carlauncher.media.action.NEXT";
    public static final String ACTION_PREVIOUS =
            "net.osmand.plus.carlauncher.media.action.PREVIOUS";
    public static final String ACTION_CLOSE =
            "net.osmand.plus.carlauncher.media.action.CLOSE";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ACTION_PLAY_PAUSE.equals(action)) {
            ...
            eventRecorder.record("MEDIA_SESSION", "diagnostic_state_changed");
        }
        updateSessionActive();
        updateSessionMetadata(null);
        updateNotification();
