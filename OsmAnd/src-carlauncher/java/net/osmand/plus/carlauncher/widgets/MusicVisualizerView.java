...
public class MusicVisualizerView extends View {
    ...
    /**
     * Reserves a small part of the visualizer for a faded bar reflection. Keeping
     * the reflection in this View avoids a second Visualizer/bitmap allocation on
     * low-memory head units.
     */
